...
export default function AdminBar({ session, active }: { session: Session; active: "orders" | "quote" | "leads" | "users" }) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 mb-6 pb-4 border-b border-[#eef1f6]">
      <div className="flex items-center gap-1">
        ...
        {tab("/admin/talepler", "Demo Talepleri", active === "leads")}
        {tab("/admin/teklif", "Yeni Teklif", active === "quote")}
